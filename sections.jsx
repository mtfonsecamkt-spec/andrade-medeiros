          ...
          <div style={{ position: 'relative', minHeight: 540 }} data-side="hero-right">
            ...
            <div style={{
              ...
              <div className="hero-photo" style={{
                width: '100%',
                height: '100%',
                background: `url(${window.IMAGES.teamPortrait}) center top/cover`,
              }} />
              {/* gold corner frames */}
      ...
      <div className="container" style={{
        ...
        <div>
          <div style={{ position: 'relative' }}>
            <img src={window.IMAGES.officeWorkstation} alt="Estação de trabalho do escritório Andrade Medeiros"
            style={{
              width: '100%',
              aspectRatio: '4/5',
              objectFit: 'cover',
...
function PartnerCard({ p }) {
  // Photo source per partner
  const photoUrl = p.id === 'isabella' ? window.IMAGES.isabella : window.IMAGES.andre;
  const focus = p.id === 'isabella' ? 'center top' : 'center top';
  return (
    <article style={{
      background: 'var(--surface)',
      border: '1px solid var(--rule)',
      ...
      <div style={{
        width: '100%',
        minHeight: 380,
        background: `url(${photoUrl}) ${focus}/cover`,
      ...
      <style>{`
        @media (max-width: 520px) {
          ...
          .partner-card .partner-photo { min-height: 260px !important; aspect-ratio: 4/3; }
        }
      `}</style>
    </article>);
      ...
      <div className="container">
        ...
        <div style={{
          ...
          <div style={{ gridRow: 'span 2', position: 'relative', overflow: 'hidden' }}>
            <img src={window.IMAGES.officeMeeting} alt="Sala de reuniões"
          ...
          <div style={{ position: 'relative', overflow: 'hidden' }}>
            <img src={window.IMAGES.officeWorkstation} alt="Estações de trabalho do escritório"
